local strings = {
	...
	SI_CBFS_BMID_ELVEN_SCROLL_NAME =	"Wood Elven Scroll",	-- "Wood Elven Scroll"
	...
	SI_CBFS_BMID_ELVEN_SCROLL_TIPS =	"Wood Elven Scroll detailing the Rite of Propagation",	-- tooltip for book medium "Wood Elven Scroll" if you want to add a description in your localization
