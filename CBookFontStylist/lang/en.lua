...
SafeAddString(SI_CBFS_BMID_YELLOWED_PAPER_NAME,         "Yellowed Paper Book", 1)   -- 
SafeAddString(SI_CBFS_BMID_ANIMAL_SKIN_NAME,            "Animal Skin Book", 1)  -- 
SafeAddString(SI_CBFS_BMID_RUBBING_PAPER_NAME,          "Rubbing Book", 1)      -- 
SafeAddString(SI_CBFS_BMID_LETTER_NAME,                 "Letter", 1)                -- 
SafeAddString(SI_CBFS_BMID_NOTE_NAME,                   "Note", 1)              -- 
SafeAddString(SI_CBFS_BMID_SCROLL_NAME,                 "Scroll", 1)                -- 
SafeAddString(SI_CBFS_BMID_STONE_TABLET_NAME,           "Stone Tablet", 1)      -- 
SafeAddString(SI_CBFS_BMID_METAL_NAME,                  "Dwemer Book", 1)           -- 
SafeAddString(SI_CBFS_BMID_METAL_TABLET_NAME,           "Dwemer Page", 1)           -- 

SafeAddString(SI_CBFS_BMID_YELLOWED_PAPER_TIPS,         "Yellowed Paper", 1)    -- 
SafeAddString(SI_CBFS_BMID_ANIMAL_SKIN_TIPS,            "Animal Skin", 1)       -- 
SafeAddString(SI_CBFS_BMID_RUBBING_PAPER_TIPS,          "Rubbing Paper", 1) -- 
SafeAddString(SI_CBFS_BMID_LETTER_TIPS,                 "Letter", 1)            -- 
SafeAddString(SI_CBFS_BMID_NOTE_TIPS,                   "Note", 1)          -- 
SafeAddString(SI_CBFS_BMID_SCROLL_TIPS,                 "Scroll", 1)            -- 
SafeAddString(SI_CBFS_BMID_STONE_TABLET_TIPS,           "Stone Tablet", 1)  -- 
SafeAddString(SI_CBFS_BMID_METAL_TIPS,                  "Metal Book", 1)        -- 
SafeAddString(SI_CBFS_BMID_METAL_TABLET_TIPS,           "Metal Tablet", 1)  -- 
...
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------
SafeAddString(SI_CBFS_UI_PREVIEW_BODY_LOCALE,           "Six big juicy steaks sizzled in a pan as five workmen left the quarry.\n\n", 1) 
...
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------
SafeAddString(SI_CBFS_UI_PREVIEW_BOOK_TITLE,            "Lorem Ipsum", 1) 
SafeAddString(SI_CBFS_UI_PREVIEW_BOOK_BODY,             "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", 1) 
}
